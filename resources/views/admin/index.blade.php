              ...
              <div class="card-content">
                <div class="row">
                  <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                    <div class="my-1 text-center">
                      <div class="card-header mb-2 pt-0">
                        <h5 class="primary">Number of users</h5>
                        <h3 class="font-large-2 text-bold-200">{{ $userCount }}</h3>
                      </div>
                      <div class="card-content">
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                    <div class="my-1 text-center">
                      <div class="card-header mb-2 pt-0">
                        <h5 class="danger">Number of Active/Non-active users</h5>
                      ...
                      <div class="card-content">
                        ...
                        <ul class="list-inline clearfix pt-1 mb-0">
                          <li class="border-right-grey border-right-lighten-2 pr-2">
                            <h2 class="grey darken-1 text-bold-400">{{ $userActiveCount }}</h2>
                            <span class="primary">
                              <span class="ft-arrow-up"></span> Active</span>
                          </li>
                          <li class="pl-2">
                            <h2 class="grey darken-1 text-bold-400">{{ $userDeactiveCount }}</h2>
                            <span class="danger">
                              <span class="ft-arrow-down"></span> Deactive</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                    <div class="my-1 text-center">
                      <div class="card-header mb-2 pt-0">
                        <h5 class="warning">Number of users (basic) subscribed user</h5>
                        <h3 class="font-large-2 text-bold-200">{{ $userSubsCount }}
                        </h3>
                      </div>
                      <div class="card-content">
                  ...
                  <div class="col-xl-3 col-lg-6 col-md-12">
                    <div class="my-1 text-center">
                      <div class="card-header mb-2 pt-0">
                        <h5 class="success">Number of users on trial (free subscription)</h5>
                        <h3 class="font-large-2 text-bold-200"> 
                          {{  $userTrailCount }}
                        </h3>
                      </div>
              ...
              <div class="card-content">
                <div class="row">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                    <div class="my-1 text-center">
                      <div class="card-header mb-2 pt-0">
                        <h5 class="danger">Number reports and blocks</h5>
                        <h3 class="font-large-2 text-bold-200">
                             {{ $reportCount }} 
                        </h3>
                      </div>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5">
                    <div class="my-1 text-center">
                      <div class="card-header mb-2 pt-0">
                        <h5 class="warning">Number of user profile picture requests</h5>
                        <h3 class="font-large-2 text-bold-200">{{ $userProfilePicRequestCount }}
                        </h3>
                      </div>
                      <div class="card-content">
                        <input type="text" value="81" class="knob hide-value responsive angle-offset" data-angleOffset="20"
          ...
          <div class="col-xl-8 col-lg-12">
            <div class="card">
              <div class="card-header border-0-bottom">
                <h4 class="card-title">Number reports and blocks
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-12 border-right-blue-grey border-right-lighten-5 clearfix">
                      <div class="media">
                        <div class="media-left pr-1">
                          <img class="media-object img-xl" src="{{ asset('app-assets/images/portrait/small/avatar-s-5.png') }}"
              ...
              <div class="card-content">
                <div id="friends-activity" class="media-list height-400 position-relative">
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="{{ asset('app-assets/images/portrait/small/avatar-s-7.png') }}"
                      alt="Generic placeholder image">
                    </div>
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="{{ asset('app-assets/images/portrait/small/avatar-s-8.png') }}"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="{{ asset('app-assets/images/portrait/small/avatar-s-9.png') }}"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="{{ asset('app-assets/images/portrait/small/avatar-s-10.png') }}"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="{{ asset('app-assets/images/portrait/small/avatar-s-11.png') }}"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
                  ...
                  <a href="#" class="media border-0">
                    <div class="media-left pr-1">
                      <img class="media-object avatar avatar-sm rounded-circle" src="{{ asset('app-assets/images/portrait/small/avatar-s-12.png') }}"
                      alt="Generic placeholder image">
                    </div>
                    <div class="media-body w-100">
            ...
            <div class="row">
                    ...
                    <div id="carousel-example" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                          <img src="{{ asset('app-assets/images/pages/fitness-slide-1.jpg')}}" class="img-fluid"
                          alt="First slide">
                        </div>
                        <div class="carousel-item">
                          <img src="{{ asset('app-assets/images/pages/fitness-slide-2.jpg')}}" class="img-fluid"
                          alt="Second slide">
                        </div>
                        <div class="carousel-item">
                          <img src="{{ asset('app-assets/images/pages/fitness-slide-3.jpg')}}" class="img-fluid"
                          alt="Third slide">
                        </div>
                      </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="card profile-card-with-cover">
                  <div class="card-content">
                    <div class="card-img-top img-fluid bg-cover height-200" style="background: url('app-assets/images/pages/fitness-profile.jpg' ) 40%;"></div>
                    <div class="card-profile-image">
                      <img src="{{ asset('app-assets/images/portrait/small/avatar-s-8.png') }}" class="rounded-circle img-border box-shadow-1"
                      alt="Card image">
                    </div>
